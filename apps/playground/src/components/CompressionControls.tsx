              ...
              : isAllImages
                ? [
                    ...
                    ...(files[0].type !== 'image/avif'
                      ? [{ value: 'avif', label: 'AVIF (High Quality)' }]
                      : []),
                    ...(!(files[0].type === 'image/jpeg' || files[0].type === 'image/jpg')
                      ? [{ value: 'jpeg', label: 'JPEG (Standard)' }]
                      : []),
                    ...(isImageFile(files[0]) && files[0].type !== 'image/png'
                ...
                : isAllAudio
                  ? [
                      ...(files[0].type !== 'audio/mpeg' && files[0].type !== 'audio/mp3'
                        ? [{ value: 'mp3', label: 'MP3 (Compressed)' }]
                        : []),
                      ...(files[0].type !== 'audio/opus'
                        ? [{ value: 'opus', label: 'Opus (Web-ready)' }]
                        : []),
                      ...(files[0].type !== 'audio/webm'
                        ? [{ value: 'webm', label: 'WebM Opus (Safari-ready)' }]
                        : []),
                      ...(isAudioFile(files[0])
                        ? [
                            ...(files[0].type !== 'audio/flac'
                              ...
                              : []),
                            ...(files[0].type !== 'audio/wav' && files[0].type !== 'audio/x-wav'
              ...
              <>
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-bold uppercase text-[var(--theme-text)]">
                      Deflate Level
                    </label>
                    <span className="text-xs font-black bg-[var(--theme-card-bg)] px-2 py-0.5 border-2 border-[var(--theme-border)]">
                      {archiveLevel}
                    </span>
                  </div>
                  <input
                ...
                {isBatch && (
                  <label className="flex items-center gap-2 cursor-pointer group mt-2">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs font-bold uppercase text-[var(--theme-text)] group-hover:opacity-100 opacity-80">
                        Smart Optimize Media
                      </span>
                      <span className="text-[10px] opacity-60">
                        Pre-compress images/audio before archiving
                      </span>
                    </div>
                  </label>
                )}
            ...
            {selectedFormat !== 'zip' && isAllVideos && (
              <>
                ...
                <div className="grid grid-cols-2 gap-4 text-[var(--theme-text)]">
                  ...
                  />
                  <div>
                    <label className="text-xs font-bold uppercase text-[var(--theme-text)] mb-1 block">
                      Max Width
                    </label>
                    <input
                      type="number"
